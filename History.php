...
<head>
  ...
  <script>
    function fnConfirmHistoryRemove(ID,pno) {
      ...
      Swal.fire({
        title: 'Are you sure?',
        text: "Want to delete this history entry?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            window.location.href = 'History.php?ID=' + ID + '&PNo=' + pno;
        }
    });
    }
  </script>
            ...
            <div class="history" >
              <?php
                ...
                if(isset($_SESSION['email']))
                {
                  ...
                  $q = "select * from tblhistory where UID='$uid'";
                  $res = mysqli_query($mysql, $q);
                  $total_records = mysqli_num_rows($res);
                  $total_pages = ceil($total_records / $limit);

                  $q = "select * from tblhistory where UID='$uid' order by HID desc limit $limit offset $offset";
                  $res = mysqli_query($mysql, $q);
                            ...
                            <li>
                                ...
                                <div class="article">
                                    <p>
                                        ...
                                        <br>
                                        <a href="index.php" class="more">do more</a>
                                    </p>
                                </div>
                            </li>
                            <?php endforeach; ?>
...
<?php
  if(isset($_REQUEST['ID'])){
    ...
    {
      header("location:History.php?page=$PNo");
    }
    else
